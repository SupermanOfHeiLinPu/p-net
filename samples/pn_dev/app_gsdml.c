...
static const app_gsdml_module_t module_io = {
   .id = APP_GSDML_MOD_ID_IO,
   .name = "IO A Word",
   .submodules = {APP_GSDML_SUBMOD_ID_IO, 0},
};
...
static const app_gsdml_submodule_t submod_digital_io = {
   .id = APP_GSDML_SUBMOD_ID_IO,
   .name = "IO A Word",
   .api = APP_GSDML_API,
   .data_dir = PNET_DIR_IO,
   .insize = APP_GSDML_OUTPUT_SIZE,
   .outsize = APP_GSDML_INPUT_SIZE,
   .parameters = {0}};
